...
create index "change_user_idx" on "Change" ("user","file");
...
create index "cluster_user_idx" on "Cluster" ("user");
...
create index "repo_file_idx" on "RepoFile" ("file");
...
create index "snapshot_user_idx" on "Snapshot" ("user");
...
create index "symbol_file_idx" on "Symbol" ("file");
